...
// matches the name of the directory that is created by the Wwise Bank SceneManager,
...
,m_pLangMap( nullptr )
,m_pSoundBanks( nullptr )
,m_pStmFiles( nullptr )
,m_pExternals( nullptr )
{
...
const CAkFilePackageLUT::AkFileEntry<AkFileID> * CAkFilePackageLUT::LookupFile(
	...
	AkFileSystemFlags * in_pFlags		// Special flags. Do not pass nullptr.
	)
{
