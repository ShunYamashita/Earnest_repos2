...
// to the Stream SceneManager, this object registers itself as the File Location Resolver.
//
//////////////////////////////////////////////////////////////////////
	...
	)
{
	...
	// If the Stream SceneManager's File Location Resolver was not set yet, set this object as the 
	// File Location Resolver (this I/O hook is also able to resolve file location).
	if ( !AK::StreamMgr::GetFileLocationResolver() )
		AK::StreamMgr::SetFileLocationResolver( this );

	// Create a device in the Stream SceneManager, specifying this as the hook.
	...
	if ( m_deviceID != AK_INVALID_DEVICE_ID )
	{
		...
		m_poolID = AK::MemoryMgr::CreatePool( nullptr, uPoolSize, sizeof( OVERLAPPED ), AkMalloc | AkFixedSizeBlocksMode );
...
AKRESULT CAkDefaultIOHookDeferred::Open( 
    ...
    AkFileSystemFlags * in_pFlags,      // Special flags. Can pass nullptr.
