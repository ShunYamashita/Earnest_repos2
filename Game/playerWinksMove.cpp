//--------------------------------------------------------------------------------------
//  プレイヤーステート( 移動 )   ( playerWinksMove.cpp )
//
...
//  初期化処理をする関数
//--------------------------------------------------------------------------------------
void PlayerWinksMove::Init( void )
{
	//  親の初期化
...
//  終了処理をする関数
//--------------------------------------------------------------------------------------
void PlayerWinksMove::Uninit( void )
{
...
//  更新処理をする関数
//--------------------------------------------------------------------------------------
void PlayerWinksMove::Update( void )
{
	//  カメラ制御
	ControlCamera( );
...
//  描画処理をする関数
//--------------------------------------------------------------------------------------
void PlayerWinksMove::Draw( void )
{
...
//  アクションをする関数
//--------------------------------------------------------------------------------------
void PlayerWinksMove::Action( void )
{
	//  カメラの取得
