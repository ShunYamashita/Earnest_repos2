//--------------------------------------------------------------------------------------
//  プレイヤーステート( HP攻撃 )   ( playerWinksHPAttack.cpp )
//
...
//  初期化処理をする関数
//--------------------------------------------------------------------------------------
void PlayerWinksHPAttack::Init( void )
{
	//  親の初期化
	...
	//  モーションの変更
	GetPlayer( )->SetMotion( FBXLoader::MOTION::HP_ATTACK );
}

//--------------------------------------------------------------------------------------
//  終了処理をする関数
//--------------------------------------------------------------------------------------
void PlayerWinksHPAttack::Uninit( void )
{
...
//  更新処理をする関数
//--------------------------------------------------------------------------------------
void PlayerWinksHPAttack::Update( void )
{
	//  カメラ制御
	ControlCamera( );
...
//  描画処理をする関数
//--------------------------------------------------------------------------------------
void PlayerWinksHPAttack::Draw( void )
{
...
//  アクションをする関数
//--------------------------------------------------------------------------------------
void PlayerWinksHPAttack::Action( void )
{
	...
	if( GetPlayer( )->GetMotionFrameRate( ) > 0.6f && m_slashEffekseer == false )
	{
