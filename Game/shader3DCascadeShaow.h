//--------------------------------------------------------------------------------------
//  3Dシェーダー ( 深度バッファによるシャドウ )プログラム   ( shader3DCascadeShadow.h )
//
//  Author : SHUN YAMASHITA
//--------------------------------------------------------------------------------------
#ifndef _SHADER_3D_CASCADE_SHADOW_H_
#define _SHADER_3D_CASCADE_SHADOW_H_
...
//--------------------------------------------------------------------------------------
class Shader3DCascadeShadow : public Shader
{
public: 
	Shader3DCascadeShadow( ){ }																//  コンストラクタ
	~Shader3DCascadeShadow( ){ }																//  デストラクタ
