//--------------------------------------------------------------------------------------
//  3Dシェーダー ( テクスチャなし )  ( shader3DNoTexture.cpp )
//
...
void Shader3DNoTexture::Init( void )
{
	...
	hr = D3DXCompileShaderFromFile( "data/HLSL/3D/noTextureVS.hlsl" ,	//  ファイル名
									NULL ,								//  
									NULL ,								//  
	...
	hr = D3DXCompileShaderFromFile( "data/HLSL/3D/noTexturePS.hlsl" ,	//  ファイル名
									NULL ,								//  
									NULL ,								//  
									"main" ,							//  エントリー関数名( 一番初めに行われる関数 )
									"ps_3_0" ,							//  シェーダモデル名
